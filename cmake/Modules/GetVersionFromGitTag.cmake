...
if (GIT_FOUND AND VERSION_UPDATE_FROM_GIT)
	...
	file(WRITE ${CMAKE_SOURCE_DIR}/VERSION ${${PROJECT_NAME}_VERSION_STRING_FULL}
        ...
        # Git not available, get version from file - which contains just one line - "major.minor.revision"
        file(STRINGS ${CMAKE_SOURCE_DIR}/VERSION ${PROJECT_NAME}_VERSION_LIST)
        set(${PROJECT_NAME}_VERSION_STRING_FULL ${${PROJECT_NAME}_VERSION_LIST})
        set(${PROJECT_NAME}_VERSION_STRING ${${PROJECT_NAME}_VERSION_LIST})
